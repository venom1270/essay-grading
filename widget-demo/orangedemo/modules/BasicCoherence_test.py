...
from orangedemo.modules.lemmatizer import lemmatizeTokens
from scipy.spatial import distance
import numpy as np
import math

class BasicCoherence_test(BaseModule):
    ...
    def calculate_any_point_distances(self, D):
        ...
        for d in D:
            n = d.shape[0]
            distances = np.triu(d)
            averages.append(np.sum(distances) / (n*(n-1)/2))
    ...
    def preprocess(self):
        ...
        # TODO: nisem ziher ce je to pravilni nacin
        self.tfidf_parts = []
