...
from orangedemo.modules import BasicMeasures, ReadabilityMeasures, LexicalDiversity, Grammar, Content, Coherence
...
from orangedemo.Attributes import Attributes
