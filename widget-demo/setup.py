...
def get_version_info():
    ...
    elif os.path.exists('orangedemo/essaygrading/version.py'):
        # must be a source distribution, use existing version file
        # load it as a separate module to not load orangecontrib/text/__init__.py
        from importlib.machinery import SourceFileLoader
        version = SourceFileLoader('orangedemo.essaygrading.version',
                                   'orangedemo/essaygrading/version.py').load_module()
...
def write_version_py(filename='orangedemo/essaygrading/version.py'):
    """ Copied from numpy setup.py. """
    cnt = """
