...
ENTRY_POINTS = {
    'orange3.addon': (
        ...
        'essaygrading = orangecontrib.essaygrading'
    ),
    ...
    'orange.widgets': (
        ...
        'Essay Grading = orangecontrib.essaygrading.widgets'
    ),
...
def get_version_info():
    ...
    elif os.path.exists('orangecontrib/essaygrading/version.py'):
        # must be a source distribution, use existing version file
        # load it as a separate module to not load orangecontrib/text/__init__.py
        from importlib.machinery import SourceFileLoader
        version = SourceFileLoader('orangecontrib.essaygrading.version',
                                   'orangecontrib/essaygrading/version.py').load_module()
