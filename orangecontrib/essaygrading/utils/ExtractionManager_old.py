...
class ExtractionManager:
    ...
    def matchEntitesWithURIRefs(self, URIRefs, type):
        ...
        it checks URIdict (dictionary for fast lookup), else checks string character matching (>70%).
        ...
        :param URIRefs: URIRefs from base ontology in format [tokens, URIREF, text, stemmed]
        :param type:
        :return:
        '''
